...
export const lessons: Lesson[] = [
    // Product 1: QuantumLeap CRM
    {
        ...
        companyDescription:
            'Mid-sized e-commerce company struggling with customer retention.',
        leadTemperature: 'warm',
        summary:
            'Sarah downloaded your ebook on customer retention and seems interested in your solution. Her main problem is high customer churn, but she has a limited budget.',
        primaryPainPoints: [
    ...
    },
    {
        ...
        companyDescription:
            'A subscription box company with flat revenue growth.',
        leadTemperature: 'mixed',
        summary:
            'Michael was referred by an investor but is happy with their current "good enough" CRM. He sees no reason to switch.',
        primaryPainPoints: [
            'Stagnant revenue growth',
            'High manual effort to find upsell opportunities',
            'Content with existing tools',
        ],
    ...
    },
    {
        ...
        companyDescription:
            'A large telecom company locked in a contract with a major competitor.',
        leadTemperature: 'cold',
        summary:
            'Jennifer is evaluating CRM providers for the next fiscal year. Your competitor is the incumbent, but their system is expensive and inflexible.',
        primaryPainPoints: [
            'High cost of the current CRM',
            'Lack of flexibility and poor reporting',
            'Long-term contract with a competitor',
        ],
    ...
    },
    {
        ...
        companyDescription:
            'A recently acquired software company under orders to slash costs.',
        leadTemperature: 'hostile',
        summary:
            'David must cut costs by 30% and consolidate all software. He sees your CRM as a non-essential expense.',
        primaryPainPoints: [
            'Aggressive cost-cutting mandate',
            'Pressure to consolidate software stack',
            'Views your product as a cost center',
        ],
    ...
    // Product 2: InnovateOS
    {
        ...
        companyDescription:
            'A consumer electronics company looking to innovate faster.',
        leadTemperature: 'warm',
        summary:
            'Amina is actively looking for ways to source and manage new product ideas from employees. She found your website through a Google search.',
        primaryPainPoints: [
            'Good ideas get lost in email chains',
            'No clear process for idea submission and evaluation',
            'Struggling to engage employees in innovation',
        ],
    ...
    },
    {
        ...
        companyDescription:
            'A large financial services firm with a complex, legacy IT infrastructure.',
        leadTemperature: 'mixed',
        summary:
            'Lucas was brought into the conversation by the Head of Innovation. He is concerned about the security and integration challenges of adding a new platform.',
        primaryPainPoints: [
            'Security vulnerabilities of new software',
    ...
    },
    {
        ...
        companyDescription:
            'A fast-growing SaaS company where the innovation team has no budget.',
        leadTemperature: 'cold',
        summary:
            'Priya is solely focused on hitting her quarterly numbers. She doesn\'t see the value in an "innovation platform" and is blocking access to the CEO.',
        primaryPainPoints: [
            'Short-term revenue focus',
            'Sees innovation as a "nice-to-have"',
            'Budget constraints for non-sales tools',
        ],
    ...
    },
    {
        ...
        companyDescription:
            'A manufacturing company that recently shut down a failed "innovation lab".',
        leadTemperature: 'hostile',
        summary:
            'Tom is extremely skeptical of any innovation-related spending after a previous initiative failed, costing the company over $1M. He thinks it\'s all "fluff".',
        primaryPainPoints: [
            'Previous failed innovation project',
            'Distrust of innovation consultants and software',
            "Belief that innovation doesn't deliver tangible results",
        ],
    ...
    // Product 3: CyberGuard Pro
    {
        ...
        character: characters[5]!, // Lucas Müller
        companyDescription:
            'A growing law firm handling sensitive client data.',
        leadTemperature: 'warm',
        summary:
            'Lucas, the IT Manager, just read an article about a competitor suffering a ransomware attack. He is actively researching security solutions.',
        primaryPainPoints: [
            'Fear of a data breach and reputational damage',
            'Unsure about their current security posture',
            'Need for a simple, all-in-one solution',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            "Michael, the owner, received your cold email but believes his business is too small to be a target for cybercriminals. He'd rather invest in marketing.",
        primaryPainPoints: [
            'Belief that they are not a target',
            'Limited budget and competing priorities',
            'Lack of understanding of cybersecurity risks',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            'David, the CFO, is reviewing the IT budget. He sees the cybersecurity line item as a pure cost and wants to reduce it.',
        primaryPainPoints: [
            'Pressure to reduce operational expenses',
            'Views cybersecurity as an insurance policy, not a business enabler',
            'Wants to see clear ROI on all spending',
        ],
    ...
    },
    {
        ...
        character: characters[9]!, // Tom Williams
        companyDescription:
            "A company that just had a data breach while using a competitor's product.",
        leadTemperature: 'hostile',
        summary:
            'Tom is furious. His company just suffered a data breach, and he blames his current security vendor. He is hostile to all salespeople and security products.',
        primaryPainPoints: [
            'Just experienced a painful data breach',
            'Lost trust in security vendors',
            'Under immense pressure from the board',
        ],
    ...
    // Product 4: GreenShift Logistics
    {
        ...
        leadTemperature: 'warm',
        summary:
            "Sarah has a new mandate to reduce the company's carbon footprint by 15% in two years. She is actively looking for solutions.",
        primaryPainPoints: [
            'Pressure to meet corporate sustainability goals',
            "Lack of visibility into their supply chain's carbon emissions",
            'Difficulty balancing cost and sustainability',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            'Michael is interested in the cost-saving aspects of your platform but is skeptical about the "green" marketing. He thinks it\'s just a premium feature he doesn\'t need.',
        primaryPainPoints: [
            'Rising fuel and operational costs',
            'Skepticism towards sustainability initiatives',
            'Focus on operational efficiency above all else',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            "Jennifer's only metric is cost per mile. She is in the final stages of negotiating with several low-cost carriers.",
        primaryPainPoints: [
            'Extreme focus on minimizing logistics costs',
            'Belief that sustainable logistics is always more expensive',
            'Long-standing relationships with incumbent low-cost carriers',
        ],
    ...
    },
    {
        ...
        character: characters[9]!, // Tom Williams
        companyDescription:
            'A medical device company where on-time delivery is critical.',
        leadTemperature: 'hostile',
        summary:
            "Tom's bonus is tied to on-time delivery. He is extremely change-averse and believes implementing a new platform will cause massive disruptions.",
        primaryPainPoints: [
            'Fear of any change to the current system',
            'Bonus tied to on-time delivery metrics',
            'Past negative experiences with software implementations',
        ],
    ...
    // Product 5: TalentSphere
    {
        ...
        leadTemperature: 'warm',
        summary:
            'Maria is concerned about losing top talent to competitors. She believes a lack of internal career growth is the main cause and is looking for solutions.',
        primaryPainPoints: [
            'High employee attrition, especially among top performers',
            'Lack of clear career paths for employees',
            'Manual and time-consuming process for internal hiring',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            'Ethan is part of the evaluation committee. He is skeptical about the "AI" in your platform and wants to understand the underlying algorithms and data models.',
        primaryPainPoints: [
            'Skepticism about AI and black-box algorithms',
            'Concerns about potential bias in the skill-mapping',
            'Needs to see the data and validate the model',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            'David doesn\'t see the ROI of an HR platform. He wants to know the hard cost savings, not "soft benefits" like employee engagement.',
        primaryPainPoints: [
            'Focus on tangible, hard-cost savings',
            'Sees HR tech as a "soft" investment',
            'Difficulty connecting employee retention to the bottom line',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'hostile',
        summary:
            'Priya believes in keeping her top performers on her team at all costs. She sees your internal mobility platform as a threat that will allow other departments to "poach" her best people.',
        primaryPainPoints: [
            'Fear of losing her top sales talent',
            "Believes internal mobility will hurt her team's performance",
            'Highly competitive and territorial culture',
        ],
    ...
    // Product 6: ConnectaCare
    {
        ...
        character: characters[1]!, // Michael Chen
        companyDescription:
            'A busy specialty clinic with long patient wait times.',
        leadTemperature: 'warm',
        summary:
            'Michael is looking for ways to improve patient flow and reduce wait times. He is exploring telehealth as an option for follow-up consultations.',
        primaryPainPoints: [
            'Long patient wait times',
            "Inefficient use of specialists' time",
            'Need to improve patient satisfaction',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            'Lucas is evaluating telehealth platforms but is extremely concerned about HIPAA compliance and data security. He has a long list of technical questions.',
        primaryPainPoints: [
            'Strict HIPAA compliance requirements',
            'Data security and patient privacy concerns',
            'Integration with their existing Electronic Health Record (EHR) system',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            "David is unsure about the reimbursement landscape for telehealth visits. He won't approve any purchase without a clear path to profitability.",
        primaryPainPoints: [
            'Uncertainty about telehealth reimbursement rates',
            'Need for a clear ROI and profitability model',
            'Budget constraints in a rural healthcare setting',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'hostile',
        summary:
            'The Chief of Surgery is a powerful figure who believes that "real medicine" happens in person. He sees telehealth as a low-quality, impersonal alternative and is actively blocking the initiative.',
        primaryPainPoints: [
            'Belief that telehealth is inferior to in-person care',
            'Resistance to changing established clinical workflows',
            'Concern about losing the "human touch" in medicine',
        ],
    ...
    // Product 7: ConstructWise
    {
        ...
        leadTemperature: 'warm',
        summary:
            'Michael is managing a large project and is overwhelmed by the amount of paperwork, change orders, and communication with subcontractors.',
        primaryPainPoints: [
            'Manual, paper-based processes',
            'Poor communication and coordination with subcontractors',
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            'Tom is a veteran superintendent who is used to doing things "the old way." He is resistant to adopting new technology and thinks it will just slow his crew down.',
        primaryPainPoints: [
            'Resistance to new technology',
            'Belief that current methods are "good enough"',
            'Concern that software will create more work for his team on site',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            'Jennifer is looking for a project management solution but is bundling it with other software and pressuring all vendors for a steep discount.',
        primaryPainPoints: [
            'Focus on getting the lowest possible price',
            'Bundling software to increase negotiating leverage',
            'Views project management software as a commodity',
        ],
    ...
    },
    {
        ...
        character: characters[3]!, // David Patel
        companyDescription:
            'A construction company that recently settled a major safety violation lawsuit.',
        leadTemperature: 'hostile',
        summary:
            "David is furious about the financial and reputational damage from a recent lawsuit. He is scrutinizing all expenses and is hostile to any new spending, even if it's for safety.",
        primaryPainPoints: [
            'Extreme cost-consciousness after a lawsuit',
            'Distrust of new systems and vendors',
            'Blames operational failures for the safety incident',
        ],
    ...
    // Product 8: Retailytics
    {
        ...
        character: characters[0]!, // Sarah Thompson
        companyDescription:
            'A fashion retail brand with several brick-and-mortar stores.',
        leadTemperature: 'warm',
        summary:
            'Sarah is responsible for in-store marketing and promotions. She is looking for data to justify her budget and optimize her campaigns.',
        primaryPainPoints: [
            'Difficulty measuring the effectiveness of in-store marketing',
            'Lack of data on customer behavior and traffic patterns',
            'Need to prove the ROI of her marketing spend',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            'Lucas is interested in the technology but has major concerns about GDPR and customer privacy. He needs to be convinced that your sensor data is anonymized and compliant.',
        primaryPainPoints: [
            'Strict GDPR and data privacy regulations',
            'Customer concerns about being "watched"',
            'Technical questions about data anonymization',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            "Michael has been using a basic traffic counting solution for years and is happy with it. He has a good relationship with the vendor and doesn't see a compelling reason to switch.",
        primaryPainPoints: [
            'Loyalty to an incumbent vendor',
            'Sees no need for more advanced analytics',
            'Views switching as a hassle',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'hostile',
        summary:
            'Corporate is trying to mandate the use of Retailytics across all stores, but a powerful group of franchisees is refusing. Tom, their leader, sees it as another top-down cost with no benefit to him.',
        primaryPainPoints: [
            'Franchisee resistance to corporate mandates',
            'Belief that the technology is just for corporate oversight',
            'Concern about the cost and complexity of implementation',
        ],
    ...
    // Product 9: Eduvolve
    {
        ...
        character: characters[8]!, // Maria Garcia
        companyDescription:
            'A fast-growing company that needs to scale its onboarding and training.',
        leadTemperature: 'warm',
        summary:
            'Maria has been tasked with creating a more scalable and engaging training program for new hires and existing employees. She is actively researching Learning Management Systems (LMS).',
        primaryPainPoints: [
            'Inefficient, manual onboarding process',
            'Low employee engagement with current training materials',
            'Need to track learning progress and measure effectiveness',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            "Priya is interested in the platform but is concerned that your off-the-shelf content won't be relevant for her team of specialized engineers. She wants to create her own content.",
        primaryPainPoints: [
            'Need for highly specialized, custom training content',
            "Concern that a generic LMS won't meet their needs",
            'Wants an easy-to-use content authoring tool',
        ],
    ...
    },
    {
        ...
        character: characters[3]!, // David Patel
        companyDescription:
            'A company that has recently undergone budget cuts.',
        leadTemperature: 'cold',
        summary:
            'David just cut the Learning & Development budget by 40%. He sees training as a non-essential expense, especially during tough economic times.',
        primaryPainPoints: [
            'Training budget has been drastically cut',
            'Sees L&D as a cost center',
            'Pressure to justify every dollar of spending',
        ],
    ...
    },
    {
        ...
        character: characters[4]!, // Amina Yusuf
        companyDescription:
            'A company with a universally hated, clunky, legacy LMS.',
        leadTemperature: 'hostile',
        summary:
            'Amina and her colleagues are cynical about any new training platform. The last one was a disaster - hard to use, irrelevant content, and mandatory. They are actively resisting any change.',
        primaryPainPoints: [
            'Negative past experience with a bad LMS',
            'Cynicism and resistance from employees',
            'Belief that all corporate training is a waste of time',
        ],
    ...
    // Product 10: AgriMax
    {
        ...
        leadTemperature: 'warm',
        summary:
            'Michael is always looking for new technologies to improve crop yields and efficiency. He saw your ad in a trade magazine and requested a demo.',
        primaryPainPoints: [
            'Need to increase crop yields',
            'Rising costs of fertilizer and pesticides',
            'Difficulty monitoring large fields effectively',
        ],
    ...
    },
    {
        ...
        character: characters[9]!, // Tom Williams
        companyDescription:
            'A family-owned farm that has been operating for generations.',
        leadTemperature: 'mixed',
        summary:
            "Tom is proud of his family's farming traditions. He is skeptical of new technology and relies on his experience and intuition.",
        primaryPainPoints: [
            'Reliance on traditional farming methods',
            'Skepticism towards technology and data',
    ...
    },
    {
        ...
        character: characters[2]!, // Jennifer Rodriguez
        companyDescription:
            'A large agricultural corporation that owns many farms.',
        leadTemperature: 'cold',
        summary:
            'Jennifer is evaluating farm management software from several vendors. She is looking for the best price and a solution that can be standardized across all their farms.',
        primaryPainPoints: [
            'Need for a standardized solution across multiple farms',
            'Focus on enterprise-level features and reporting',
    ...
    },
    {
        ...
        character: characters[5]!, // Lucas Müller
        companyDescription:
            'A farm in a remote, rural area with unreliable internet connectivity.',
        leadTemperature: 'hostile',
        summary:
            'Lucas is interested in the technology but has tried other software that failed because of his poor internet connection. He is frustrated and believes no cloud-based solution will work for him.',
        primaryPainPoints: [
            'Poor or unreliable internet connectivity',
            'Negative experience with other cloud-based software',
            'Need for a solution with robust offline capabilities',
        ],
    ...
    // Product 11: FinOptic
    {
        ...
        leadTemperature: 'warm',
        summary:
            'Ethan is looking for tools to help him stand out from the competition and provide more value to his clients. He is intrigued by the idea of using AI to optimize portfolios.',
        primaryPainPoints: [
            'Competition from robo-advisors',
            'Need to provide more personalized advice',
            'Time-consuming manual portfolio analysis',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            'Lucas is from the compliance department. He is concerned about the "black box" nature of the AI and needs to ensure that its recommendations are explainable and defensible.',
        primaryPainPoints: [
            'Regulatory and compliance concerns (FINRA, SEC)',
            'Need for explainable AI (XAI)',
            'Fear of AI making non-compliant recommendations',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            'Tom has been in the business for 40 years and trusts his own judgment above any algorithm. He sees AI as a gimmick for younger advisors who lack experience.',
        primaryPainPoints: [
            'Belief that human experience is superior to AI',
            'Resistance to new technology',
            'Sees AI as a threat to his professional judgment',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'hostile',
        summary:
            "David's firm has invested millions in developing its own proprietary portfolio optimization software. He is dismissive of outside vendors and believes their in-house solution is superior.",
        primaryPainPoints: [
            'Massive investment in a proprietary in-house system',
            '"Not invented here" syndrome',
            'Belief that their tool is superior',
        ],
    ...
    // Product 12: EventHorizon
    {
        ...
        character: characters[0]!, // Sarah Thompson
        companyDescription:
            'A company that runs a large annual tech conference.',
        leadTemperature: 'warm',
        summary:
            'Sarah is looking for a platform for their upcoming hybrid event. She needs to provide a great experience for both in-person and virtual attendees.',
        primaryPainPoints: [
            'Difficulty engaging virtual attendees',
            'Need for seamless networking between in-person and virtual participants',
            'Complex logistics of a hybrid event',
        ],
    ...
    },
    {
        ...
        character: characters[6]!, // Priya Singh
        companyDescription:
            'A trade association that relies on event sponsorships for revenue.',
        leadTemperature: 'mixed',
        summary:
            'Priya is concerned that a virtual or hybrid event will offer less value to her sponsors. She needs to be convinced that she can still sell high-value sponsorship packages.',
        primaryPainPoints: [
            'Fear of losing sponsorship revenue',
            'Difficulty demonstrating ROI to sponsors in a virtual setting',
            'Need for creative virtual sponsorship opportunities',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            'David is questioning the expense of a large-scale event and the associated platform costs. He is considering canceling the event altogether or just doing a simple webinar.',
        primaryPainPoints: [
            'Pressure to reduce marketing and event spend',
            'Questioning the ROI of large events',
            'Looking for cheaper alternatives like simple webinar software',
        ],
    ...
    },
    {
        ...
        character: characters[9]!, // Tom Williams
        companyDescription:
            'A company whose last virtual event was a technical and engagement disaster.',
        leadTemperature: 'hostile',
        summary:
            'Tom, the CEO, is furious about their last virtual event. It had technical glitches, low attendance, and was described as "death by PowerPoint." He is completely against doing another virtual event.',
        primaryPainPoints: [
            'Extremely negative past experience with a virtual event',
            'Belief that all virtual events are boring and ineffective ("Zoom fatigue")',
            'Lost trust in event technology platforms',
        ],
    ...
    // Product 13: AutoFlow
    {
        ...
        character: characters[1]!, // Michael Chen
        companyDescription:
            'A manufacturing plant struggling to find skilled labor.',
        leadTemperature: 'warm',
        summary:
            'Michael is having trouble filling positions on the assembly line. He is looking into automation as a potential solution for repetitive tasks.',
        primaryPainPoints: [
            'Skilled labor shortage',
            'High employee turnover in repetitive jobs',
            'Need to increase production output without adding headcount',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            "Maria is the union representative. She is concerned that automation will lead to job losses for her members and is skeptical of the company's motives.",
        primaryPainPoints: [
            'Fear of job losses due to automation',
            'Concern that the company is trying to break the union',
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            'David is comparing your RPA solution to a much cheaper, less sophisticated one from a smaller vendor. He is focused purely on the upfront capital expenditure.',
        primaryPainPoints: [
            'Focus on minimizing upfront capital cost',
            'Sees automation solutions as a commodity',
            'Is being tempted by a low-cost, but likely inferior, competitor',
        ],
    ...
    },
    {
        ...
        character: characters[9]!, // Tom Williams
        companyDescription:
            'A company where a previous robotics project failed to deliver results.',
        leadTemperature: 'hostile',
        summary:
            'Tom championed a major automation project a few years ago that went over budget and failed to deliver the promised efficiency gains. He is now extremely risk-averse and hostile to any new automation proposals.',
        primaryPainPoints: [
            'Burned by a previous, failed automation project',
            'Lost credibility and is now highly risk-averse',
            'Believes automation is overhyped and too complex',
        ],
    ...
    // Product 14: LegalEase
    {
        ...
        leadTemperature: 'warm',
        summary:
            'Amina is the sole in-house counsel and is buried in contracts. She is looking for a way to speed up her contract review process.',
        primaryPainPoints: [
            'High volume of contracts to review',
            'Manual and time-consuming review process',
            'Bottleneck for the sales and procurement teams',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            "Lucas is concerned about uploading highly confidential contracts to a third-party cloud platform. He needs to be assured of the platform's security and confidentiality measures.",
        primaryPainPoints: [
            'Extreme sensitivity of legal data',
            'Concerns about data security and attorney-client privilege',
            'Wants an on-premise or private cloud deployment option',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'cold',
        summary:
            'Tom believes that contract review is a core legal skill that cannot and should not be automated. He is resistant to technology that he feels devalues the work of his lawyers.',
        primaryPainPoints: [
            'Belief that legal work cannot be automated',
            'Fear that technology will commoditize their services',
            'Traditional, change-resistant culture',
        ],
    ...
    },
    {
        ...
        character: characters[3]!, // David Patel
        companyDescription:
            'A private equity-owned company under pressure to cut costs.',
        leadTemperature: 'hostile',
        summary:
            'David sees the legal department as a pure cost center and is looking to reduce its budget, including spending on outside counsel. He is hostile to any new spending on legal tech.',
        primaryPainPoints: [
            'Pressure to cut legal department costs',
            'Views legal as a cost center to be minimized',
            "Doesn't see the ROI of legal tech",
        ],
    ...
    // Product 15: MediaMogul
    {
        ...
        character: characters[0]!, // Sarah Thompson
        companyDescription:
            'A B2B company with an active content marketing program.',
        leadTemperature: 'warm',
        summary:
            'Sarah is struggling to manage and distribute content across their blog, social media channels, and email newsletters. She is looking for a unified platform.',
        primaryPainPoints: [
            'Using multiple, disconnected tools for content management',
            'Wasting time copying and pasting content between systems',
            'Difficulty tracking content performance across channels',
        ],
    ...
    },
    {
        ...
        leadTemperature: 'mixed',
        summary:
            'Ethan is skeptical of your "AI-powered performance prediction." He wants to understand the model and see if it\'s any better than their own internal forecasts.',
        primaryPainPoints: [
            'Skepticism about the accuracy of AI predictions',
            'Wants to understand the data model and features',
            'Believes their internal analytics are superior',
        ],
    ...
    },
    {
        ...
        character: characters[6]!, // Priya Singh
        companyDescription:
            'A company with a major sales and marketing divide.',
        leadTemperature: 'cold',
        summary:
            'Priya, the Head of Sales, believes her team generates all the real leads. She sees marketing content as "fluff" and doesn\'t encourage her team to use it.',
        primaryPainPoints: [
            'Sales and marketing misalignment',
            "Sales team doesn't use or value marketing content",
            "Difficulty proving marketing's contribution to revenue",
        ],
    ...
    },
    {
        ...
        leadTemperature: 'hostile',
        summary:
            'Tom, the new CMO, just signed a multi-year deal with your biggest competitor a month ago at his previous job and is planning to bring them in. He has no interest in talking to you.',
        primaryPainPoints: [
            'Just signed a long-term contract with a competitor',
            'Has a strong existing relationship with that competitor',
            'Wants to standardize on the tool he knows and trusts',
        ],
