  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {streamingMessage && (
              <Badge type="pill-color" color="brand" className="flex items-center gap-1">
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-gray-500 max-w-md">
              Start a conversation by typing a message below. I'm here to help you with any questions or guidance you need.
            </p>
          </div>
        ) : (
          messages.map((message) => (
            ...
            >
              <Card className={cn('max-w-[80%] p-4 shadow-inner',
                message.role === 'user' 
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="whitespace-pre-wrap break-words">
                      <Streamdown key={message.id}>{message.content}</Streamdown>
                      {message.id === messages[messages.length - 1]?.id && streamingMessage && (
      ...
      <div className="sticky bottom-0 p-5 pt-0 bg-white">
        ...
        {messages.length === 0 && <div className="mt-1 flex flex-wrap gap-2 text-xs text-zinc-700">
            <MessageExample 
...
function MessageExample({ text, onClick }: { text: string, onClick: (text: string) => void }) {
    return (
        <div 
