...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                'bg-brand text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset hover:bg-brand data-loading:bg-brand',
        ...
        'link-color': {
            root: [
                'justify-normal rounded p-0! text-brand hover:text-brand',
                // Inner text underline
                '*:data-text:underline *:data-text:decoration-transparent *:data-text:underline-offset-2 hover:*:data-text:decoration-current',
                // Icon styles
                '*:data-icon:text-fg-brand hover:*:data-icon:text-fg-brand',
            ].join(' '),
        },
        'primary-destructive': {
            root: [
